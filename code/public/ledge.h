...
{
 public:
  //Default constructor that can take in an optional ledge year (in
  //none is provided the program will detect a year)
  ...
  /*
        Params:
            player
        Function:
            sets the value of the player in the map to the player that
  ...
  */
  ...
  // Loads the ledge from a file of filename. Returns 0 for no error
  // and 1 for error.
